...
description: How to submit your extension to the ted-extensions registry
---
...
The ted-extensions registry is a GitHub repository. Publishing is done via a Pull Request — no accounts or tokens required beyond a GitHub account.

## Step 1: Fork the Registry

Go to [github.com/tomlin7/ted-extensions](https://github.com/tomlin7/ted-extensions) and click **Fork**.

Clone your fork locally:

```bash
git clone https://github.com/<your-username>/ted-extensions
cd ted-extensions
```
...
Then open a Pull Request against `tomlin7/ted-extensions`. The CI workflow will automatically run the validator on your PR.
